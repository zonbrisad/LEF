 ...
 * Reset causes.
 */
#define POWER_ON_RESET()            (MCUCR & (1<<PORF))
#define BROWN_OUT_RESET()           (MCUCR & (1<<BORF))
#define WATCH_DOG_RESET()           (MCUCR & (1<<WDRF))
#define JTAG_RESET_RESET()          (MCUCR & (1<<JTRF))
#define EXTERNAL_RESET()            (MCUCR & (1<<EXTRF))
#define CLEAR_RESETS()              MCUCR  &= ~31              /* clearing all resets */
...
/**
 * Arduino Mega specifics.
 * -----------------------------------------------------------------*/

#define ARDUINO_LED_INIT()             DDRB  |= (1<<PB7)
#define ARDUINO_LED_ON()               PORTB |= (1<<PB7)
#define ARDUINO_LED_OFF()              PORTB &= ~(1<<PB7)
#define ARDUINO_LED_TOGGLE()           PORTB ^= (1<<PB7)
#define ARDUINO_IS_LED_ON()            (PINB && (1<<PB7))
